...
/////////////////////////////////////////////////////
    ...
    glColor3f(1*a/255.0, 1*a/255.0, 1*a/255.0);
        glVertex3f(46.0+x, -44.0, 15.0-8.0);
        glVertex3f(46.0+x, -34.0, 15.0-8.0);
        glVertex3f(46.0+x, -34.0, -5.0-8.0);
        glVertex3f(46.0+x, -44.0, -5.0-8.0);
        glEnd();
    ...
    glBegin(GL_LINES);
    glColor3f(0,0,0);
        glVertex3f(47.0, -44.0, 15.0-8.0);
        glVertex3f(47.0, -34.0, 15.0-8.0);

        glVertex3f(47.0, -34.0, -5.0-8.0);
        glVertex3f(47.0, -44.0, -5.0-8.0);
        ...
        glBegin(GL_LINES);
    glColor3f(0,0,0);
        glVertex3f(46.0, -44.0, 14.0-8.0);
        glVertex3f(46.0, -50.0, 14.0-8.0);
        glVertex3f(46.0, -50.0, -4.0-8.0);
        glVertex3f(46.0, -44.0, -4.0-8.0);
        glEnd();
...
void jendela_samping_pintu(void){
    ///kiri
    glBegin(GL_QUADS);
    glColor3f(192/255.0, 192/255.0, 192/255.0);
    glVertex3f(-34.0, -50.0, 10.0);
    glVertex3f(-34.0, -35.0, 10.0);
    glVertex3f(-19.0, -35.0, 10.0);
    glVertex3f(-19.0, -50.0, 10.0);
    glEnd();
    ...
    glBegin(GL_LINES);
    glColor3f(0/255.0, 0/255.0, 0/255.0);
    glVertex3f(-24.0, -50.0, 10.0);
    glVertex3f(-24.0, -35.0, 10.0);
    glEnd();

    glBegin(GL_LINES);
    glColor3f(0/255.0, 0/255.0, 0/255.0);
    glVertex3f(-29.0, -50.0, 10.0);
    glVertex3f(-29.0, -35.0, 10.0);
    glEnd();

    glBegin(GL_LINES);
    glColor3f(0/255.0, 0/255.0, 0/255.0);
    glVertex3f(-34.0, -40.0, 10.0);
...
float x;
    ...
    for(int j=0;j<4;j++){
        for(int i=0;i<2;i++){
            glBegin(GL_QUADS);
            glColor3f(192/255.0, 192/255.0, 192/255.0);
            glVertex3f(-130.0, 10.0-y, 28.0-z);
            glVertex3f(-130.0, 22.0-y, 28.0-z);
            glVertex3f(-130.0, 22.0-y, 6.0-z);
            glVertex3f(-130.0, 10.0-y, 6.0-z);
            glEnd();
            ...
            glBegin(GL_LINES);
            glColor3f(0/255.0, 0/255.0, 0/255.0);
            glVertex3f(-130.0,10.0-y,21.0-z);
            glVertex3f(-130.0,22.0-y,21.0-z);
            glEnd();

            glBegin(GL_LINES);
            glColor3f(0/255.0, 0/255.0, 0/255.0);
            glVertex3f(-130.0,10.0-y,14.0-z);
            glVertex3f(-130.0,22.0-y,14.0-z);
            glEnd();

            glBegin(GL_LINES);
            glColor3f(0/255.0, 0/255.0, 0/255.0);
            glVertex3f(-130.0,18.0-y,28.0-z);
            glVertex3f(-130.0,18.0-y,6.0-z);
            glEnd();

            glBegin(GL_LINES);
            glColor3f(0/255.0, 0/255.0, 0/255.0);
            glVertex3f(-130.0,10.0-y,27.0-z);
            glVertex3f(-130.0,22.0-y,27.0-z);
            glEnd();

            glBegin(GL_LINES);
            glColor3f(0/255.0, 0/255.0, 0/255.0);
            glVertex3f(-130.0,10.0-y,26.0-z);
            glVertex3f(-130.0,22.0-y,26.0-z);
            glEnd();

            glBegin(GL_LINES);
            glColor3f(0/255.0, 0/255.0, 0/255.0);
            glVertex3f(-130.0,10.0-y,25.0-z);
            glVertex3f(-130.0,22.0-y,25.0-z);
            glEnd();

            glBegin(GL_LINES);
            glColor3f(0/255.0, 0/255.0, 0/255.0);
            glVertex3f(-130.0,10.0-y,24.0-z);
            glVertex3f(-130.0,22.0-y,24.0-z);
            glEnd();

            glBegin(GL_LINES);
            glColor3f(0/255.0, 0/255.0, 0/255.0);
            glVertex3f(-130.0,10.0-y,7.0-z);
            glVertex3f(-130.0,22.0-y,7.0-z);
            glEnd();

            glBegin(GL_LINES);
            glColor3f(0/255.0, 0/255.0, 0/255.0);
            glVertex3f(-130.0,10.0-y,8.0-z);
            glVertex3f(-130.0,22.0-y,8.0-z);
            glEnd();

            glBegin(GL_LINES);
            glColor3f(0/255.0, 0/255.0, 0/255.0);
            glVertex3f(-130.0,10.0-y,9.0-z);
            glVertex3f(-130.0,22.0-y,9.0-z);
            glEnd();

            glBegin(GL_LINES);
            glColor3f(0/255.0, 0/255.0, 0/255.0);
            glVertex3f(-130.0,10.0-y,10.0-z);
            glVertex3f(-130.0,22.0-y,10.0-z);
            glEnd();

            glBegin(GL_LINES);
            glColor3f(0/255.0, 0/255.0, 0/255.0);
            glVertex3f(-130.0,20.7-y,28.0-z);
            glVertex3f(-130.0,20.7-y,24.0-z);
            glEnd();

            glBegin(GL_LINES);
            glColor3f(0/255.0, 0/255.0, 0/255.0);
            glVertex3f(-130.0,19.4-y,28.0-z);
            glVertex3f(-130.0,19.4-y,24.0-z);
            glEnd();

            glBegin(GL_LINES);
            glColor3f(0/255.0, 0/255.0, 0/255.0);
            glVertex3f(-130.0,17.0-y,28.0-z);
            glVertex3f(-130.0,17.0-y,24.0-z);
            glEnd();

            glBegin(GL_LINES);
            glColor3f(0/255.0, 0/255.0, 0/255.0);
            glVertex3f(-130.0,15.5-y,28.0-z);
            glVertex3f(-130.0,15.5-y,24.0-z);
            glEnd();

            glBegin(GL_LINES);
            glColor3f(0/255.0, 0/255.0, 0/255.0);
            glVertex3f(-130.0,14.0-y,28.0-z);
            glVertex3f(-130.0,14.0-y,24.0-z);
            glEnd();

            glBegin(GL_LINES);
            glColor3f(0/255.0, 0/255.0, 0/255.0);
            glVertex3f(-130.0,12.5-y,28.0-z);
            glVertex3f(-130.0,12.5-y,24.0-z);
            glEnd();

            glBegin(GL_LINES);
            glColor3f(0/255.0, 0/255.0, 0/255.0);
            glVertex3f(-130.0,11.0-y,28.0-z);
            glVertex3f(-130.0,11.0-y,24.0-z);
            glEnd();

            glBegin(GL_LINES);
            glColor3f(0/255.0, 0/255.0, 0/255.0);
            glVertex3f(-130.0,20.7-y,10.0-z);
            glVertex3f(-130.0,20.7-y,6.0-z);
            glEnd();

            glBegin(GL_LINES);
            glColor3f(0/255.0, 0/255.0, 0/255.0);
            glVertex3f(-130.0,19.4-y,10.0-z);
            glVertex3f(-130.0,19.4-y,6.0-z);
            glEnd();

            glBegin(GL_LINES);
            glColor3f(0/255.0, 0/255.0, 0/255.0);
            glVertex3f(-130.0,17.0-y,10.0-z);
            glVertex3f(-130.0,17.0-y,6.0-z);
            glEnd();

            glBegin(GL_LINES);
            glColor3f(0/255.0, 0/255.0, 0/255.0);
            glVertex3f(-130.0,15.5-y,10.0-z);
            glVertex3f(-130.0,15.5-y,6.0-z);
            glEnd();

            glBegin(GL_LINES);
            glColor3f(0/255.0, 0/255.0, 0/255.0);
            glVertex3f(-130.0,14.0-y,10.0-z);
            glVertex3f(-130.0,14.0-y,6.0-z);
            glEnd();

            glBegin(GL_LINES);
            glColor3f(0/255.0, 0/255.0, 0/255.0);
            glVertex3f(-130.0,12.5-y,10.0-z);
            glVertex3f(-130.0,12.5-y,6.0-z);
            glEnd();

            glBegin(GL_LINES);
            glColor3f(0/255.0, 0/255.0, 0/255.0);
            glVertex3f(-130.0,11.0-y,10.0-z);
            glVertex3f(-130.0,11.0-y,6.0-z);
            glEnd();
            z+=23;
        }
        y+=18;
...
for(int j=0;j<4;j++){
        for(int i=0;i<3;i++){
            glBegin(GL_QUADS);
            glColor3f(192/255.0, 192/255.0, 192/255.0);
            glVertex3f(-180.0, 10.0-y, 28.0-52-z);
            glVertex3f(-180.0, 22.0-y, 28.0-52-z);
            glVertex3f(-180.0, 22.0-y, 6.0-52-z);
            glVertex3f(-180.0, 10.0-y, 6.0-52-z);
            glEnd();
            ...
            glBegin(GL_LINES);
            glColor3f(0/255.0, 0/255.0, 0/255.0);
            glVertex3f(-180.0,10.0-y,21.0-52-z);
            glVertex3f(-180.0,22.0-y,21.0-52-z);
            glEnd();

            glBegin(GL_LINES);
            glColor3f(0/255.0, 0/255.0, 0/255.0);
            glVertex3f(-180.0,10.0-y,14.0-52-z);
            glVertex3f(-180.0,22.0-y,14.0-52-z);
            glEnd();

            glBegin(GL_LINES);
            glColor3f(0/255.0, 0/255.0, 0/255.0);
            glVertex3f(-180.0,18.0-y,28.0-52-z);
            glVertex3f(-180.0,18.0-y,6.0-52-z);
            glEnd();

            glBegin(GL_LINES);
            glColor3f(0/255.0, 0/255.0, 0/255.0);
            glVertex3f(-180.0,10.0-y,27.0-52-z);
            glVertex3f(-180.0,22.0-y,27.0-52-z);
            glEnd();

            glBegin(GL_LINES);
            glColor3f(0/255.0, 0/255.0, 0/255.0);
            glVertex3f(-180.0,10.0-y,26.0-52-z);
            glVertex3f(-180.0,22.0-y,26.0-52-z);
            glEnd();

            glBegin(GL_LINES);
            glColor3f(0/255.0, 0/255.0, 0/255.0);
            glVertex3f(-180.0,10.0-y,25.0-52-z);
            glVertex3f(-180.0,22.0-y,25.0-52-z);
            glEnd();

            glBegin(GL_LINES);
            glColor3f(0/255.0, 0/255.0, 0/255.0);
            glVertex3f(-180.0,10.0-y,24.0-52-z);
            glVertex3f(-180.0,22.0-y,24.0-52-z);
            glEnd();

            glBegin(GL_LINES);
            glColor3f(0/255.0, 0/255.0, 0/255.0);
            glVertex3f(-180.0,10.0-y,7.0-52-z);
            glVertex3f(-180.0,22.0-y,7.0-52-z);
            glEnd();

            glBegin(GL_LINES);
            glColor3f(0/255.0, 0/255.0, 0/255.0);
            glVertex3f(-180.0,10.0-y,8.0-52-z);
            glVertex3f(-180.0,22.0-y,8.0-52-z);
            glEnd();

            glBegin(GL_LINES);
            glColor3f(0/255.0, 0/255.0, 0/255.0);
            glVertex3f(-180.0,10.0-y,9.0-52-z);
            glVertex3f(-180.0,22.0-y,9.0-52-z);
            glEnd();

            glBegin(GL_LINES);
            glColor3f(0/255.0, 0/255.0, 0/255.0);
            glVertex3f(-180.0,10.0-y,10.0-52-z);
            glVertex3f(-180.0,22.0-y,10.0-52-z);
            glEnd();

            glBegin(GL_LINES);
            glColor3f(0/255.0, 0/255.0, 0/255.0);
            glVertex3f(-180.0,20.7-y,28.0-52-z);
            glVertex3f(-180.0,20.7-y,24.0-52-z);
            glEnd();

            glBegin(GL_LINES);
            glColor3f(0/255.0, 0/255.0, 0/255.0);
            glVertex3f(-180.0,19.4-y,28.0-52-z);
            glVertex3f(-180.0,19.4-y,24.0-52-z);
            glEnd();

            glBegin(GL_LINES);
            glColor3f(0/255.0, 0/255.0, 0/255.0);
            glVertex3f(-180.0,17.0-y,28.0-52-z);
            glVertex3f(-180.0,17.0-y,24.0-52-z);
            glEnd();

            glBegin(GL_LINES);
            glColor3f(0/255.0, 0/255.0, 0/255.0);
            glVertex3f(-180.0,15.5-y,28.0-52-z);
            glVertex3f(-180.0,15.5-y,24.0-52-z);
            glEnd();

            glBegin(GL_LINES);
            glColor3f(0/255.0, 0/255.0, 0/255.0);
            glVertex3f(-180.0,14.0-y,28.0-52-z);
            glVertex3f(-180.0,14.0-y,24.0-52-z);
            glEnd();

            glBegin(GL_LINES);
            glColor3f(0/255.0, 0/255.0, 0/255.0);
            glVertex3f(-180.0,12.5-y,28.0-52-z);
            glVertex3f(-180.0,12.5-y,24.0-52-z);
            glEnd();

            glBegin(GL_LINES);
            glColor3f(0/255.0, 0/255.0, 0/255.0);
            glVertex3f(-180.0,11.0-y,28.0-52-z);
            glVertex3f(-180.0,11.0-y,24.0-52-z);
            glEnd();

            glBegin(GL_LINES);
            glColor3f(0/255.0, 0/255.0, 0/255.0);
            glVertex3f(-180.0,20.7-y,10.0-52-z);
            glVertex3f(-180.0,20.7-y,6.0-52-z);
            glEnd();

            glBegin(GL_LINES);
            glColor3f(0/255.0, 0/255.0, 0/255.0);
            glVertex3f(-180.0,19.4-y,10.0-52-z);
            glVertex3f(-180.0,19.4-y,6.0-52-z);
            glEnd();

            glBegin(GL_LINES);
            glColor3f(0/255.0, 0/255.0, 0/255.0);
            glVertex3f(-180.0,17.0-y,10.0-52-z);
            glVertex3f(-180.0,17.0-y,6.0-52-z);
            glEnd();

            glBegin(GL_LINES);
            glColor3f(0/255.0, 0/255.0, 0/255.0);
            glVertex3f(-180.0,15.5-y,10.0-52-z);
            glVertex3f(-180.0,15.5-y,6.0-52-z);
            glEnd();

            glBegin(GL_LINES);
            glColor3f(0/255.0, 0/255.0, 0/255.0);
            glVertex3f(-180.0,14.0-y,10.0-52-z);
            glVertex3f(-180.0,14.0-y,6.0-52-z);
            glEnd();

            glBegin(GL_LINES);
            glColor3f(0/255.0, 0/255.0, 0/255.0);
            glVertex3f(-180.0,12.5-y,10.0-52-z);
            glVertex3f(-180.0,12.5-y,6.0-52-z);
            glEnd();

            glBegin(GL_LINES);
            glColor3f(0/255.0, 0/255.0, 0/255.0);
            glVertex3f(-180.0,11.0-y,10.0-52-z);
            glVertex3f(-180.0,11.0-y,6.0-52-z);
            glEnd();
            z+=25;
        }
        y+=18;
...
x=0,y=0;
    for(int j=0;j<4;j++){
        for(int i=0;i<13;i++){
            glBegin(GL_QUADS);
            glColor3f(192/255.0, 192/255.0, 192/255.0);
            glVertex3f(-125.0-50+x, 10.0-y, -100.0);
            glVertex3f(-125.0-50+x, 22.0-y, -100.0);
            glVertex3f(-103.0-50+x, 22.0-y, -100.0);
            glVertex3f(-103.0-50+x, 10.0-y, -100.0);
            glEnd();
            ...
            glBegin(GL_LINES);
            glColor3f(0/255.0, 0/255.0, 0/255.0);
            glVertex3f(-118.0-50+x,10.0-y,-100.0);
            glVertex3f(-118.0-50+x,22.0-y,-100.0);
            glEnd();

            glBegin(GL_LINES);
            glColor3f(0/255.0, 0/255.0, 0/255.0);
            glVertex3f(-111.0-50+x,10.0-y,-100.0);
            glVertex3f(-111.0-50+x,22.0-y,-100.0);
            glEnd();

            glBegin(GL_LINES);
            glColor3f(0/255.0, 0/255.0, 0/255.0);
            glVertex3f(-125.0-50+x,18.0-y,-100.0);
            glVertex3f(-103.0-50+x,18.0-y,-100.0);
            glEnd();

            glBegin(GL_LINES);
            glColor3f(0/255.0, 0/255.0, 0/255.0);
            glVertex3f(-124.0-50+x,10.0-y,-100.0);
            glVertex3f(-124.0-50+x,22.0-y,-100.0);
            glEnd();

            glBegin(GL_LINES);
            glColor3f(0/255.0, 0/255.0, 0/255.0);
            glVertex3f(-123.0-50+x,10.0-y,-100.0);
            glVertex3f(-123.0-50+x,22.0-y,-100.0);
            glEnd();

            glBegin(GL_LINES);
            glColor3f(0/255.0, 0/255.0, 0/255.0);
            glVertex3f(-122.0-50+x,10.0-y,-100.0);
            glVertex3f(-122.0-50+x,22.0-y,-100.0);
            glEnd();

            glBegin(GL_LINES);
            glColor3f(0/255.0, 0/255.0, 0/255.0);
            glVertex3f(-121.0-50+x,10.0-y,-100.0);
            glVertex3f(-121.0-50+x,22.0-y,-100.0);
            glEnd();

            glBegin(GL_LINES);
            glColor3f(0/255.0, 0/255.0, 0/255.0);
            glVertex3f(-107.0-50+x,10.0-y,-100.0);
            glVertex3f(-107.0-50+x,22.0-y,-100.0);
            glEnd();

            glBegin(GL_LINES);
            glColor3f(0/255.0, 0/255.0, 0/255.0);
            glVertex3f(-106.0-50+x,10.0-y,-100.0);
            glVertex3f(-106.0-50+x,22.0-y,-100.0);
            glEnd();

            glBegin(GL_LINES);
            glColor3f(0/255.0, 0/255.0, 0/255.0);
            glVertex3f(-105.0-50+x,10.0-y,-100.0);
            glVertex3f(-105.0-50+x,22.0-y,-100.0);
            glEnd();

            glBegin(GL_LINES);
            glColor3f(0/255.0, 0/255.0, 0/255.0);
            glVertex3f(-104.0-50+x,10.0-y,-100.0);
            glVertex3f(-104.0-50+x,22.0-y,-100.0);
            glEnd();

            glBegin(GL_LINES);
            glColor3f(0/255.0, 0/255.0, 0/255.0);
            glVertex3f(-125.0-50+x,20.7-y,-100.0);
            glVertex3f(-121.0-50+x,20.7-y,-100.0);
            glEnd();

            glBegin(GL_LINES);
            glColor3f(0/255.0, 0/255.0, 0/255.0);
            glVertex3f(-125.0-50+x,19.4-y,-100.0);
            glVertex3f(-121.0-50+x,19.4-y,-100.0);
            glEnd();

            glBegin(GL_LINES);
            glColor3f(0/255.0, 0/255.0, 0/255.0);
            glVertex3f(-125.0-50+x,17.0-y,-100.0);
            glVertex3f(-121.0-50+x,17.0-y,-100.0);
            glEnd();

            glBegin(GL_LINES);
            glColor3f(0/255.0, 0/255.0, 0/255.0);
            glVertex3f(-125.0-50+x,15.5-y,-100.0);
            glVertex3f(-121.0-50+x,15.5-y,-100.0);
            glEnd();

            glBegin(GL_LINES);
            glColor3f(0/255.0, 0/255.0, 0/255.0);
            glVertex3f(-125.0-50+x,14.0-y,-100.0);
            glVertex3f(-121.0-50+x,14.0-y,-100.0);
            glEnd();

            glBegin(GL_LINES);
            glColor3f(0/255.0, 0/255.0, 0/255.0);
            glVertex3f(-125.0-50+x,12.5-y,-100.0);
            glVertex3f(-121.0-50+x,12.5-y,-100.0);
            glEnd();

            glBegin(GL_LINES);
            glColor3f(0/255.0, 0/255.0, 0/255.0);
            glVertex3f(-125.0-50+x,11.0-y,-100.0);
            glVertex3f(-121.0-50+x,11.0-y,-100.0);
            glEnd();

            glBegin(GL_LINES);
            glColor3f(0/255.0, 0/255.0, 0/255.0);
            glVertex3f(-107.0-50+x,20.7-y,-100.0);
            glVertex3f(-103.0-50+x,20.7-y,-100.0);
            glEnd();

            glBegin(GL_LINES);
            glColor3f(0/255.0, 0/255.0, 0/255.0);
            glVertex3f(-107.0-50+x,19.4-y,-100.0);
            glVertex3f(-103.0-50+x,19.4-y,-100.0);
            glEnd();

            glBegin(GL_LINES);
            glColor3f(0/255.0, 0/255.0, 0/255.0);
            glVertex3f(-107.0-50+x,17.0-y,-100.0);
            glVertex3f(-103.0-50+x,17.0-y,-100.0);
            glEnd();

            glBegin(GL_LINES);
            glColor3f(0/255.0, 0/255.0, 0/255.0);
            glVertex3f(-107.0-50+x,15.5-y,-100.0);
            glVertex3f(-103.0-50+x,15.5-y,-100.0);
            glEnd();

            glBegin(GL_LINES);
            glColor3f(0/255.0, 0/255.0, 0/255.0);
            glVertex3f(-107.0-50+x,14.0-y,-100.0);
            glVertex3f(-103.0-50+x,14.0-y,-100.0);
            glEnd();

            glBegin(GL_LINES);
            glColor3f(0/255.0, 0/255.0, 0/255.0);
            glVertex3f(-107.0-50+x,12.5-y,-100.0);
            glVertex3f(-103.0-50+x,12.5-y,-100.0);
            glEnd();

            glBegin(GL_LINES);
            glColor3f(0/255.0, 0/255.0, 0/255.0);
            glVertex3f(-107.0-50+x,11.0-y,-100.0);
            glVertex3f(-103.0-50+x,11.0-y,-100.0);
            glEnd();
            x+=27.4;
        }
        y+=18;
...
x=0,y=0;
    for(int j=0;j<4;j++){
        for(int i=0;i<2;i++){
            glBegin(GL_QUADS);
            glColor3f(192/255.0, 192/255.0, 192/255.0);
            glVertex3f(-125.0-53+x, 10.0-y, -20.0);
            glVertex3f(-125.0-53+x, 22.0-y, -20.0);
            glVertex3f(-103.0-53+x, 22.0-y, -20.0);
            glVertex3f(-103.0-53+x, 10.0-y, -20.0);
            glEnd();
            ...
            glBegin(GL_LINES);
            glColor3f(0/255.0, 0/255.0, 0/255.0);
            glVertex3f(-118.0-53+x,10.0-y,-20.0);
            glVertex3f(-118.0-53+x,22.0-y,-20.0);
            glEnd();

            glBegin(GL_LINES);
            glColor3f(0/255.0, 0/255.0, 0/255.0);
            glVertex3f(-111.0-53+x,10.0-y,-20.0);
            glVertex3f(-111.0-53+x,22.0-y,-20.0);
            glEnd();

            glBegin(GL_LINES);
            glColor3f(0/255.0, 0/255.0, 0/255.0);
            glVertex3f(-125.0-53+x,18.0-y,-20.0);
            glVertex3f(-103.0-53+x,18.0-y,-20.0);
            glEnd();

            glBegin(GL_LINES);
            glColor3f(0/255.0, 0/255.0, 0/255.0);
            glVertex3f(-124.0-53+x,10.0-y,-20.0);
            glVertex3f(-124.0-53+x,22.0-y,-20.0);
            glEnd();

            glBegin(GL_LINES);
            glColor3f(0/255.0, 0/255.0, 0/255.0);
            glVertex3f(-123.0-53+x,10.0-y,-20.0);
            glVertex3f(-123.0-53+x,22.0-y,-20.0);
            glEnd();

            glBegin(GL_LINES);
            glColor3f(0/255.0, 0/255.0, 0/255.0);
            glVertex3f(-122.0-53+x,10.0-y,-20.0);
            glVertex3f(-122.0-53+x,22.0-y,-20.0);
            glEnd();

            glBegin(GL_LINES);
            glColor3f(0/255.0, 0/255.0, 0/255.0);
            glVertex3f(-121.0-53+x,10.0-y,-20.0);
            glVertex3f(-121.0-53+x,22.0-y,-20.0);
            glEnd();

            glBegin(GL_LINES);
            glColor3f(0/255.0, 0/255.0, 0/255.0);
            glVertex3f(-107.0-53+x,10.0-y,-20.0);
            glVertex3f(-107.0-53+x,22.0-y,-20.0);
            glEnd();

            glBegin(GL_LINES);
            glColor3f(0/255.0, 0/255.0, 0/255.0);
            glVertex3f(-106.0-53+x,10.0-y,-20.0);
            glVertex3f(-106.0-53+x,22.0-y,-20.0);
            glEnd();

            glBegin(GL_LINES);
            glColor3f(0/255.0, 0/255.0, 0/255.0);
            glVertex3f(-105.0-53+x,10.0-y,-20.0);
            glVertex3f(-105.0-53+x,22.0-y,-20.0);
            glEnd();

            glBegin(GL_LINES);
            glColor3f(0/255.0, 0/255.0, 0/255.0);
            glVertex3f(-104.0-53+x,10.0-y,-20.0);
            glVertex3f(-104.0-53+x,22.0-y,-20.0);
            glEnd();

            glBegin(GL_LINES);
            glColor3f(0/255.0, 0/255.0, 0/255.0);
            glVertex3f(-125.0-53+x,20.7-y,-20.0);
            glVertex3f(-121.0-53+x,20.7-y,-20.0);
            glEnd();

            glBegin(GL_LINES);
            glColor3f(0/255.0, 0/255.0, 0/255.0);
            glVertex3f(-125.0-53+x,19.4-y,-20.0);
            glVertex3f(-121.0-53+x,19.4-y,-20.0);
            glEnd();

            glBegin(GL_LINES);
            glColor3f(0/255.0, 0/255.0, 0/255.0);
            glVertex3f(-125.0-53+x,17.0-y,-20.0);
            glVertex3f(-121.0-53+x,17.0-y,-20.0);
            glEnd();

            glBegin(GL_LINES);
            glColor3f(0/255.0, 0/255.0, 0/255.0);
            glVertex3f(-125.0-53+x,15.5-y,-20.0);
            glVertex3f(-121.0-53+x,15.5-y,-20.0);
            glEnd();

            glBegin(GL_LINES);
            glColor3f(0/255.0, 0/255.0, 0/255.0);
            glVertex3f(-125.0-53+x,14.0-y,-20.0);
            glVertex3f(-121.0-53+x,14.0-y,-20.0);
            glEnd();

            glBegin(GL_LINES);
            glColor3f(0/255.0, 0/255.0, 0/255.0);
            glVertex3f(-125.0-53+x,12.5-y,-20.0);
            glVertex3f(-121.0-53+x,12.5-y,-20.0);
            glEnd();

            glBegin(GL_LINES);
            glColor3f(0/255.0, 0/255.0, 0/255.0);
            glVertex3f(-125.0-53+x,11.0-y,-20.0);
            glVertex3f(-121.0-53+x,11.0-y,-20.0);
            glEnd();

            glBegin(GL_LINES);
            glColor3f(0/255.0, 0/255.0, 0/255.0);
            glVertex3f(-107.0-53+x,20.7-y,-20.0);
            glVertex3f(-103.0-53+x,20.7-y,-20.0);
            glEnd();

            glBegin(GL_LINES);
            glColor3f(0/255.0, 0/255.0, 0/255.0);
            glVertex3f(-107.0-53+x,19.4-y,-20.0);
            glVertex3f(-103.0-53+x,19.4-y,-20.0);
            glEnd();

            glBegin(GL_LINES);
            glColor3f(0/255.0, 0/255.0, 0/255.0);
            glVertex3f(-107.0-53+x,17.0-y,-20.0);
            glVertex3f(-103.0-53+x,17.0-y,-20.0);
            glEnd();

            glBegin(GL_LINES);
            glColor3f(0/255.0, 0/255.0, 0/255.0);
            glVertex3f(-107.0-53+x,15.5-y,-20.0);
            glVertex3f(-103.0-53+x,15.5-y,-20.0);
            glEnd();

            glBegin(GL_LINES);
            glColor3f(0/255.0, 0/255.0, 0/255.0);
            glVertex3f(-107.0-53+x,14.0-y,-20.0);
            glVertex3f(-103.0-53+x,14.0-y,-20.0);
            glEnd();

            glBegin(GL_LINES);
            glColor3f(0/255.0, 0/255.0, 0/255.0);
            glVertex3f(-107.0-53+x,12.5-y,-20.0);
            glVertex3f(-103.0-53+x,12.5-y,-20.0);
            glEnd();

            glBegin(GL_LINES);
            glColor3f(0/255.0, 0/255.0, 0/255.0);
            glVertex3f(-107.0-53+x,11.0-y,-20.0);
            glVertex3f(-103.0-53+x,11.0-y,-20.0);
            glEnd();
            x+=23;
        }
        y+=18;
...
x=0,y=0;
    for(int j=0;j<4;j++){
        for(int i=0;i<2;i++){
            ...
            glBegin(GL_LINES);
            glColor3f(0/255, 0/255.0, 0/255.0);
            glVertex3f(125.0+53-x,15.5-y,-20.0);
            glVertex3f(121.0+53-x,15.5-y,-20.0);
            glEnd();
...
void jendela_lt5(void){
    glLineWidth(3.0);
    ///tengah
    glBegin(GL_QUADS);
    glColor3f(192/255.0, 192/255.0, 192/255.0);
    glVertex3f(-14.0, 32.0, 10.0);
    glVertex3f(-14.0, 44.0, 10.0);
    glVertex3f(14.0, 44.0, 10.0);
    glVertex3f(14.0, 32.0, 10.0);
    glEnd();
    ...
    glBegin(GL_LINES);
    glColor3f(0/255.0, 0/255.0, 0/255.0);
    glVertex3f(-13.0,32.0,10.0);
    glVertex3f(-13.0,44.0,10.0);
    glEnd();

    glBegin(GL_LINES);
    glColor3f(0/255.0, 0/255.0, 0/255.0);
    glVertex3f(-12.0,32.0,10.0);
    glVertex3f(-12.0,44.0,10.0);
    glEnd();

    glBegin(GL_LINES);
    glColor3f(0/255.0, 0/255.0, 0/255.0);
    glVertex3f(-11.0,32.0,10.0);
    glVertex3f(-11.0,44.0,10.0);
    glEnd();

    glBegin(GL_LINES);
    glColor3f(0/255.0, 0/255.0, 0/255.0);
    glVertex3f(-10.0,32.0,10.0);
    glVertex3f(-10.0,44.0,10.0);
    glEnd();
    ...
    glBegin(GL_LINES);
    glColor3f(0/255.0, 0/255.0, 0/255.0);
    glVertex3f(-5.0,32.0,10.0);
    glVertex3f(-5.0,44.0,10.0);
    glEnd();
    ...
    glBegin(GL_LINES);
    glColor3f(0/255.0, 0/255.0, 0/255.0);
    glVertex3f(-3.0,32.0,10.0);
    glVertex3f(-3.0,44.0,10.0);
    glEnd();
    ...
    glBegin(GL_LINES);
    glColor3f(0/255.0, 0/255.0, 0/255.0);
    glVertex3f(-14.0,33.5,10.0);
    glVertex3f(-10.0,33.5,10.0);
    glEnd();

    glBegin(GL_LINES);
    glColor3f(0/255.0, 0/255.0, 0/255.0);
    glVertex3f(-14.0,35.0,10.0);
    glVertex3f(-10.0,35.0,10.0);
    glEnd();

    glBegin(GL_LINES);
    glColor3f(0/255.0, 0/255.0, 0/255.0);
    glVertex3f(-14.0,36.5,10.0);
    glVertex3f(-10.0,36.5,10.0);
    glEnd();

    glBegin(GL_LINES);
    glColor3f(0/255.0, 0/255.0, 0/255.0);
    glVertex3f(-14.0,38.0,10.0);
    glVertex3f(14.0,38.0,10.0);
    glEnd();

    glBegin(GL_LINES);
    glColor3f(0/255.0, 0/255.0, 0/255.0);
    glVertex3f(-14.0,39.5,10.0);
    glVertex3f(-10.0,39.5,10.0);
    glEnd();

    glBegin(GL_LINES);
    glColor3f(0/255.0, 0/255.0, 0/255.0);
    glVertex3f(-14.0,41.0,10.0);
    glVertex3f(-10.0,41.0,10.0);
    glEnd();

    glBegin(GL_LINES);
    glColor3f(0/255.0, 0/255.0, 0/255.0);
    glVertex3f(-14.0,42.5,10.0);
    glVertex3f(-10.0,42.5,10.0);
    glEnd();
    ...
    for(int k=0;k<3;k++){
        glBegin(GL_QUADS);
        glColor3f(192/255.0, 192/255.0, 192/255.0);
        glVertex3f(-83.0+s, 32.0, 10.0);
        glVertex3f(-83.0+s, 44.0, 10.0);
        glVertex3f(-65.0+s, 44.0, 10.0);
        glVertex3f(-65.0+s, 32.0, 10.0);
        glEnd();
        ...
        glBegin(GL_LINES);
        glColor3f(0/255.0, 0/255.0, 0/255.0);
        glVertex3f(-82.0+s,32.0,10.0);
        glVertex3f(-82.0+s,44.0,10.0);
        glEnd();

        glBegin(GL_LINES);
        glColor3f(0/255.0, 0/255.0, 0/255.0);
        glVertex3f(-81.0+s,32.0,10.0);
        glVertex3f(-81.0+s,44.0,10.0);
        glEnd();

        glBegin(GL_LINES);
        glColor3f(0/255.0, 0/255.0, 0/255.0);
        glVertex3f(-80.0+s,32.0,10.0);
        glVertex3f(-80.0+s,44.0,10.0);
        glEnd();

        glBegin(GL_LINES);
        glColor3f(0/255.0, 0/255.0, 0/255.0);
        glVertex3f(-79.0+s,32.0,10.0);
        glVertex3f(-79.0+s,44.0,10.0);
        glEnd();

        glBegin(GL_LINES);
        glColor3f(0/255.0, 0/255.0, 0/255.0);
        glVertex3f(-66.0+s,32.0,10.0);
        glVertex3f(-66.0+s,44.0,10.0);
        glEnd();

        glBegin(GL_LINES);
        glColor3f(0/255.0, 0/255.0, 0/255.0);
        glVertex3f(-67.0+s,32.0,10.0);
        glVertex3f(-67.0+s,44.0,10.0);
        glEnd();

        glBegin(GL_LINES);
        glColor3f(0/255.0, 0/255.0, 0/255.0);
        glVertex3f(-68.0+s,32.0,10.0);
        glVertex3f(-68.0+s,44.0,10.0);
        glEnd();

        glBegin(GL_LINES);
        glColor3f(0/255.0, 0/255.0, 0/255.0);
        glVertex3f(-69.0+s,32.0,10.0);
        glVertex3f(-69.0+s,44.0,10.0);
        glEnd();

        glBegin(GL_LINES);
        glColor3f(0/255.0, 0/255.0, 0/255.0);
        glVertex3f(-71.0+s,32.0,10.0);
        glVertex3f(-71.0+s,44.0,10.0);
        glEnd();

        glBegin(GL_LINES);
        glColor3f(0/255.0, 0/255.0, 0/255.0);
        glVertex3f(-77.0+s,32.0,10.0);
        glVertex3f(-77.0+s,44.0,10.0);
        glEnd();

        glBegin(GL_LINES);
        glColor3f(0/255.0, 0/255.0, 0/255.0);
        glVertex3f(-69.0+s,33.5,10.0);
        glVertex3f(-65.0+s,33.5,10.0);
        glEnd();

        glBegin(GL_LINES);
        glColor3f(0/255.0, 0/255.0, 0/255.0);
        glVertex3f(-69.0+s,35.0,10.0);
        glVertex3f(-65.0+s,35.0,10.0);
        glEnd();

        glBegin(GL_LINES);
        glColor3f(0/255.0, 0/255.0, 0/255.0);
        glVertex3f(-69.0+s,36.5,10.0);
        glVertex3f(-65.0+s,36.5,10.0);
        glEnd();

        glBegin(GL_LINES);
        glColor3f(0/255.0, 0/255.0, 0/255.0);
        glVertex3f(-83.0+s,38.0,10.0);
        glVertex3f(-65.0+s,38.0,10.0);
        glEnd();

        glBegin(GL_LINES);
        glColor3f(0/255.0, 0/255.0, 0/255.0);
        glVertex3f(-69.0+s,39.5,10.0);
        glVertex3f(-65.0+s,39.5,10.0);
        glEnd();

        glBegin(GL_LINES);
        glColor3f(0/255.0, 0/255.0, 0/255.0);
        glVertex3f(-69.0+s,41.0,10.0);
        glVertex3f(-65.0+s,41.0,10.0);
        glEnd();

        glBegin(GL_LINES);
        glColor3f(0/255.0, 0/255.0, 0/255.0);
        glVertex3f(-69.0+s,42.5,10.0);
        glVertex3f(-65.0+s,42.5,10.0);
        glEnd();

        glBegin(GL_LINES);
        glColor3f(0/255.0, 0/255.0, 0/255.0);
        glVertex3f(-83.0+s,33.5,10.0);
        glVertex3f(-79.0+s,33.5,10.0);
        glEnd();

        glBegin(GL_LINES);
        glColor3f(0/255.0, 0/255.0, 0/255.0);
        glVertex3f(-83.0+s,35.0,10.0);
        glVertex3f(-79.0+s,35.0,10.0);
        glEnd();

        glBegin(GL_LINES);
        glColor3f(0/255.0, 0/255.0, 0/255.0);
        glVertex3f(-83.0+s,36.5,10.0);
        glVertex3f(-79.0+s,36.5,10.0);
        glEnd();

        glBegin(GL_LINES);
        glColor3f(0/255.0, 0/255.0, 0/255.0);
        glVertex3f(-83.0+s,39.5,10.0);
        glVertex3f(-79.0+s,39.5,10.0);
        glEnd();

        glBegin(GL_LINES);
        glColor3f(0/255.0, 0/255.0, 0/255.0);
        glVertex3f(-83.0+s,41.0,10.0);
        glVertex3f(-79.0+s,41.0,10.0);
        glEnd();

        glBegin(GL_LINES);
        glColor3f(0/255.0, 0/255.0, 0/255.0);
        glVertex3f(-83.0+s,42.5,10.0);
        glVertex3f(-79.0+s,42.5,10.0);
        glEnd();
        s+=21.3;
    }
...
void jendela(void){
    ...
    for(int j=0;j<3;j++){
        for(int i=0;i<2;i++){
            ...
            glBegin(GL_LINES);
            glColor3f(0/255.0, 0/255.0, 0/255.0);
            glVertex3f(-14.0,20.7-y,10.0);
            glVertex3f(-10.0,20.7-y,10.0);
            glEnd();

            glBegin(GL_LINES);
            glColor3f(0/255.0, 0/255.0, 0/255.0);
            glVertex3f(-14.0,19.4-y,10.0);
            glVertex3f(-10.0,19.4-y,10.0);
            glEnd();

            glBegin(GL_LINES);
            glColor3f(0/255.0, 0/255.0, 0/255.0);
            glVertex3f(-14.0,17.0-y,10.0);
            glVertex3f(-10.0,17.0-y,10.0);
            glEnd();

            glBegin(GL_LINES);
            glColor3f(0/255.0, 0/255.0, 0/255.0);
            glVertex3f(-14.0,15.5-y,10.0);
            glVertex3f(-10.0,15.5-y,10.0);
            glEnd();

            glBegin(GL_LINES);
            glColor3f(0/255.0, 0/255.0, 0/255.0);
            glVertex3f(-14.0,14.0-y,10.0);
            glVertex3f(-10.0,14.0-y,10.0);
            glEnd();

            glBegin(GL_LINES);
            glColor3f(0/255.0, 0/255.0, 0/255.0);
            glVertex3f(-14.0,12.5-y,10.0);
            glVertex3f(-10.0,12.5-y,10.0);
            glEnd();

            glBegin(GL_LINES);
            glColor3f(0/255.0, 0/255.0, 0/255.0);
            glVertex3f(-14.0,11.0-y,10.0);
            glVertex3f(-10.0,11.0-y,10.0);
            glEnd();
...
void balkon(void){
    ...
    glBegin(GL_QUADS);
    glColor3f(192/255.0, 192/255.0, 192/255.0);
    glVertex3f(-55.0, 10.0+x, 10.0);
    glVertex3f(-55.0, 22.0+x, 10.0);
    glVertex3f(-45.0, 22.0+x, 10.0);
    glVertex3f(-45.0, 10.0+x, 10.0);
    glEnd();
    ...
    glBegin(GL_LINES);
    glColor3f(0/255.0, 0/255.0, 0/255.0);
    glVertex3f(-55.0, 18.0+x, 10.0);
    glVertex3f(-45.0, 18.0+x, 10.0);
    glEnd();

    glBegin(GL_LINES);
    glColor3f(0/255.0, 0/255.0, 0/255.0);
    glVertex3f(-50.0, 10.0+x, 10.0);
    glVertex3f(-50.0, 18.0+x, 10.0);
    glEnd();
    ...
    for (int i=0;i<4;i++){
        ...
        glVertex3f(-50.0, -30.0+x, 30.0);
        glVertex3f(-45.0, -30.0+x, 20.0);
    ...
    for (int i=0;i<3;i++){
        glBegin(GL_POLYGON);
        glColor3f(176/255.0, 196/255.0, 222/255.0);
        glVertex3f(-55.0, -15.0+x, 30.0);
        glVertex3f(-55.0, -10.0+x, 30.0);
        glVertex3f(-50.0, -10.0+x, 30.0);
        glVertex3f(-50.0, -15.0+x, 30.0);
        glEnd();
        ...
        glVertex3f(-50.0, -15.0+x, 30.0);
        glVertex3f(-50.0, -10.0+x, 30.0);
        glVertex3f(-45.0, -10.0+x, 20.0);
        glVertex3f(-45.0, -15.0+x, 20.0);
        glEnd();
        ...
        glBegin(GL_LINES);
        glColor3f(119/255.0, 136/255.0, 153/255.0);
        glVertex3f(-55.0, -28.0+x, 30.0);
        glVertex3f(-50.0, -28.0+x, 30.0);
        glVertex3f(-50.0, -28.0+x, 30.0);
        glVertex3f(-45.0, -28.0+x, 20.0);
        glVertex3f(-45.0, -28.0+x, 20.0);
        glVertex3f(-45.0, -28.0+x, 10.0);
        glEnd();

        glBegin(GL_LINES);
        glColor3f(119/255.0, 136/255.0, 153/255.0);
        glVertex3f(-55.0, -26.0+x, 30.0);
        glVertex3f(-50.0, -26.0+x, 30.0);
        glVertex3f(-50.0, -26.0+x, 30.0);
        glVertex3f(-45.0, -26.0+x, 20.0);
        glVertex3f(-45.0, -26.0+x, 20.0);
        glVertex3f(-45.0, -26.0+x, 10.0);
        glEnd();

        glBegin(GL_LINES);
        glColor3f(119/255.0, 136/255.0, 153/255.0);
        glVertex3f(-55.0, -17.0+x, 30.0);
        glVertex3f(-50.0, -17.0+x, 30.0);
        glVertex3f(-50.0, -17.0+x, 30.0);
        glVertex3f(-45.0, -17.0+x, 20.0);
        glVertex3f(-45.0, -17.0+x, 20.0);
        glVertex3f(-45.0, -17.0+x, 10.0);
        glEnd();
        x+=20;
    }
...
void dinding_lt1(void){
    ...
    glVertex3f(-55.0, -32.0, 35.0);
    glVertex3f(-55.0, -32.0, 30.0);
    glVertex3f(-130.0, -32.0, 30.0);
    glVertex3f(-130.0, -32.0, 35.0);
    glEnd();
    ...
    glBegin(GL_QUADS);
    glColor3f(238/255.0, 232/255.0, 170/255.0);
    glVertex3f(-55.0, -44.0, 35.0);
    glVertex3f(-55.0, -44.0, 30.0);
    glVertex3f(-130.0, -44.0, 30.0);
    glVertex3f(-130.0, -44.0, 35.0);
    glEnd();
    ...
    glBegin(GL_QUADS);
    glColor3f(238/255.0, 232/255.0, 170/255.0);
    glVertex3f(-35.0, -30.0, 15.0);
    glVertex3f(-35.0, -30.0, 10.0);
    glVertex3f(-17.0, -30.0, 10.0);
    glVertex3f(-17.0, -30.0, 15.0);
    glEnd();

    glBegin(GL_QUADS);
    glColor3f(238/255.0, 232/255.0, 170/255.0);
    glVertex3f(-35.0, -34.0, 15.0);
    glVertex3f(-35.0, -34.0, 10.0);
    glVertex3f(-17.0, -34.0, 10.0);
    glVertex3f(-17.0, -34.0, 15.0);
    glEnd();
...
void aspal(void){
    ...
    glBegin(GL_QUADS);
        glColor3f(200/255.0, 200/255.0, 200/255.0);
        glVertex3f(-200.0, -52.0, 100.0);
        glVertex3f(-200.0, -52.0, -150.0);
        glVertex3f(200.0, -52.0, -150.0);
        glVertex3f(200.0, -52.0, 100.0);
        glEnd();
